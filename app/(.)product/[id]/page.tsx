              ...
              <div className="flex gap-x-8 h-96">
                ...
                <div className="flex-1 flex flex-col">
                  ...
                  <div className="space-y-3 text-sm">
                    <button onClick={handleAddToCart}  className="button w-full bg-blue-600 text-white border-transparent hover:border-blue-600 hover:bg-transparent hover:text-black">
                      Add to bag
                    </button>
                    <button
